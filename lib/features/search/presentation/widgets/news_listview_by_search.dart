...
class NewsListBySearchWidget extends StatelessWidget {
  const NewsListBySearchWidget({
    super.key,
  });
  @override
  Widget build(BuildContext context) {
    // context.read<NewsCubit>().getNewsBySearch("general");
    return BlocBuilder<NewsCubit, NewsState>(
      builder: (context, state) {
        if (state is NewsBySearchSuccess) {
        ...
        } else if (state is NewsBySearchError) {
